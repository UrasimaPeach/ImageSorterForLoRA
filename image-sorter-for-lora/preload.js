...
contextBridge.exposeInMainWorld('apis', {
  ...
  runClickEventCopyToHere: async (targetDirectoryIndex, imageTagsString, removeTagsString) => ipcRenderer.invoke('click-event-cth', targetDirectoryIndex, imageTagsString, removeTagsString),
